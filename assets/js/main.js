(function ($) {
	...
	setTimeout(() => {
		var slider = new Swiper('.tp-featured-slider-active-fav', {
			slidesPerView: 3,
			spaceBetween: 10,
			loop: true,
			autoplay: {
			...
			navigation: {
				nextEl: ".tp-featured-slider-button-next-fav",
				prevEl: ".tp-featured-slider-button-prev-fav",
			},
			breakpoints: {
				1200: {
					slidesPerView: 3,
	...
	setTimeout(() => {
		var slider = new Swiper('.tp-featured-slider-active-news', {
			slidesPerView: 1,
			spaceBetween: 10,
			loop: true,
			autoplay: true,
			...
			navigation: {
				nextEl: ".tp-featured-slider-button-next-news",
				prevEl: ".tp-featured-slider-button-prev-news",
			},
			breakpoints: {
	...
	}, 300);  // 500ms ka delay Swiper ko proper initialize karne ke liye




	// var slider = new Swiper('.tp-featured-slider-active-clients', {
	// 	slidesPerView: 8,
	// 	spaceBetween: 20,
	// 	loop: true,
	// 	autoplay: true,
	...
	// 	// Navigation arrows
	// 	navigation: {
	// 		nextEl: ".tp-featured-slider-button-next-clients",
	// 		prevEl: ".tp-featured-slider-button-prev-clients",
	// 	},
	...
	var slider = new Swiper('.tp-featured-slider-active-clients', {
		...
		loop: true,
		rtl: rtl_setting,
		speed: 4000, // control how smooth/fast it scrolls
		autoplay: {
			delay: 0, // make it seamless
			disableOnInteraction: false,
		},
		allowTouchMove: false, // optional: disables dragging so it feels like an infinite marquee
		pagination: {
			el: ".tp-featured-slider-dot",
			clickable: true,
			renderBullet: function (index, className) {
	...
	}, 500); // 500ms delay se initialize hoga
