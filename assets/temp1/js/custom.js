...
var Pixio = function () {
	...
	var scrollTop = function () {
		var scrollTop = jQuery("../error-1.html");
		...
		jQuery(window).bind("scroll", function () {
			...
			if (scroll > 900) {
				jQuery("../error-1.html").fadeIn(1000);
			} else {
				jQuery("../error-1.html").fadeOut(1000);
			}
		});
	...
	var handleVideo = function () {
		...
		jQuery('iframe[src*="../error-1.html"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>');
		jQuery('iframe[src*="../error-1.html"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>');
	...
	var handleCurrentActive = function () {
		for (var nk = window.location, o = $("../error-1.html").filter(function () {
			return this.href == nk;
	...
	// 						<form action="../error-1.html" class="dzSubscribe" method="post">
	...
	return {
		init: function () {
			...
			handelResize();
			jQuery('.modal').on('../error-1.html', reposition);
			priceslider();
			handleCurrentActive();
			handleShopCart();
